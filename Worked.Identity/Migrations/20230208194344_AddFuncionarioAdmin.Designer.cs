...
namespace Worked.Infra.Migrations
{
    ...
    [Migration("20230208194344_AddFuncionarioAdmin")]
    partial class AddFuncionarioAdmin
    {
            ...
            modelBuilder.Entity("Worked.Domain.Entities.Funcionario", b =>
                {
                    b.HasOne("Worked.Domain.Entities.Cargo", "Cargo")
                        .WithOne("Funcionario")
                        .HasForeignKey("Worked.Domain.Entities.Funcionario", "CargoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Worked.Domain.Entities.RegimeTrabalhista", "RegimeTrabalhista")
                        .WithOne("Funcionario")
                        .HasForeignKey("Worked.Domain.Entities.Funcionario", "RegimeTrabalhistaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
